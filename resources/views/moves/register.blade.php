            ...
            <div class="col-md-12">
                <div class="panel" id="wizard-wrapper">
                    ...
                    <div class="panel-body">
                        <div class="phone-type-wrapper">
                            <h2>Choose your phone type</h2>
                            <div class="form-group labelauty-div " style="display:inline-block;margin-left:20px;">
                                <input type="radio" class="to-labelauty" name="inputLableautyRadio" data-plugin="labelauty"
                                       data-labelauty="iPhone"  v-model="phoneType" value="iphone" checked/>
                            </div>
                            <div class="form-group labelauty-div" style="display:inline-block;margin-left:20px;">
                                <input type="radio" class="to-labelauty" name="inputLableautyRadio" data-plugin="labelauty"
                                       data-labelauty="Android" v-model="phoneType" value="android" />
                            </div>
                        </div>
                        <!-- Panel Wizard Forms -->
                        @include('moves.iphone-wizard')
                        @include('moves.android-wizard')
